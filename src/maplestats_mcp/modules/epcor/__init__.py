...
Rossdale) and publishes no API; the tool here reads a public HTML page.
...
MODULE_DESCRIPTION = (
    ...
    "alkalinity, conductivity, caustic soda, last 7 days). EPCOR's monthly "
    "and annual reports are PDF documents and are not covered."
)
