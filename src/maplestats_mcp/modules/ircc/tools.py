...
from maplestats_mcp.modules.ircc import client
from maplestats_mcp.modules.ircc.constants import ROUNDS_LIMIT_DEFAULT
from maplestats_mcp.modules.ircc.schemas import ExpressEntryRoundDetail, ExpressEntryRoundsResult
...
async def ircc_list_express_entry_rounds(
    ...
    has no server-side filtering, so MapleStats fetches the full history
