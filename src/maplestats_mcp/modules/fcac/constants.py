...
# ten products (95 Ontario credit cards took 10 requests). 2 per second
# matches the other legacy ASP.NET portal here (cmhc) and keeps a full
# search to about five seconds.
