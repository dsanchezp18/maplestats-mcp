...
def _socrata_spec(args: dict[str, Any]) -> Spec:
    from maple_data_mcp.modules.socrata.constants import PORTALS
...
def _ckan_spec(args: dict[str, Any]) -> Spec:
    from maple_data_mcp.modules.ckan.constants import PORTALS
...
def _census_table_spec(pid: str, release: str) -> Spec:
    from maple_data_mcp.modules.statcan.census_tables.constants import HOST, RELEASES
