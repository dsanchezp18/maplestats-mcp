...
from maple_data_mcp.modules.arcgis_ottawa import client, constants
...
async def test_get_dataset_maps_item_detail_and_download_links(httpx_mock):
    ...
    result = await client.get_dataset("14cca5b087f74d2d9eadc018c261d1b3")
...
async def test_query_feature_layer_returns_attributes(httpx_mock):
    ...
    result = await client.query_feature_layer("14cca5b087f74d2d9eadc018c261d1b3")
...
async def test_feature_service_embedded_error_becomes_invalid_input(httpx_mock):
    ...
    with pytest.raises(InvalidInput):
        await client.query_feature_layer("14cca5b087f74d2d9eadc018c261d1b3", where="garbage==")
