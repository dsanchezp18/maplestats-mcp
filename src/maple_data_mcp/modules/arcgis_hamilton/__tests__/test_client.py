...
from maple_data_mcp.modules.arcgis_hamilton import client, constants
...
_SEARCH_FEATURE = {
    ...
    "properties": {
        ...
        "snippet": "Feature layer of current Boil Water Advisories issued in Hamilton.",
        "type": "Feature Service",
        "tags": ["Boil Water Advisories", "Hamilton"],
        "categories": ["/Categories/Environment"],
        "owner": "Hamilton_Government",
...
_ITEM_DETAIL_FEATURE = {
    ...
    "properties": {
        ...
        "categories": ["/Categories/Environment"],
        "owner": "Hamilton_Government",
        "licenseInfo": "<a href='https://www.hamilton.ca/legal'>Hamilton Open Data Licence</a>",
...
async def test_search_parses_hub_search_fields(httpx_mock):
    ...
    assert result.items[0].tags == ["Boil Water Advisories", "Hamilton"]
