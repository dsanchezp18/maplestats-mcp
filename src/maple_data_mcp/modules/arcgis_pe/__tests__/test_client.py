...
from maple_data_mcp.modules.arcgis_pe import client, constants
...
_SEARCH_FEATURE = {
    ...
    "properties": {
        ...
        "snippet": "Feature layer of current Boil Water Advisories issued in Prince Edward Island.",
        "type": "Feature Service",
        "tags": ["Boil Water Advisories", "Prince Edward Island"],
        "categories": ["/Categories/Environment"],
        "owner": "pei_enterprise_admin",
...
_ITEM_DETAIL_FEATURE = {
    ...
    "properties": {
        ...
        "categories": ["/Categories/Environment"],
        "owner": "pei_enterprise_admin",
        "licenseInfo": "<a href='https://www.princeedwardisland.ca/en/information/finance/open-government-licence-prince-edward-island'>Prince Edward Island Open Data Licence</a>",
...
async def test_search_parses_hub_search_fields(httpx_mock):
    ...
    assert result.items[0].tags == ["Boil Water Advisories", "Prince Edward Island"]
