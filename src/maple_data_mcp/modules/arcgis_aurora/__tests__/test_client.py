...
from maple_data_mcp.modules.arcgis_aurora import client, constants
...
_SEARCH_FEATURE = {
    "id": "b4195c9917694c7c9053a28025a2aff3",
    "type": "Feature",
    "geometry": None,
    "properties": {
        "id": "b4195c9917694c7c9053a28025a2aff3",
        "title": "WasteCollectionBoundary_WFL1",
        "snippet": "Polygon representation of the boundaries for the waste collection days in Aurora.",
        "type": "Feature Service",
        "tags": ["Aurora", "waste", "collection day"],
        "categories": [],
        "owner": "TownOfAurora",
        "modified": 1774462633000,
        "numViews": 2695,
    },
}

_ITEM_DETAIL_FEATURE = {
    "id": "b4195c9917694c7c9053a28025a2aff3_0",
    "type": "Feature",
    "geometry": None,
    "properties": {
        "id": "b4195c9917694c7c9053a28025a2aff3",
        "title": "WasteCollectionBoundary_WFL1",
        "description": "Polygon representation of the boundaries for the waste collection days in Aurora.",
        "type": "Feature Service",
        "tags": ["Aurora", "waste", "collection day"],
        "categories": [],
        "owner": "TownOfAurora",
        "licenseInfo": "<p>Town of Aurora Open Data Licence.</p>",
        "created": 1644944601000,
        "modified": 1774462633000,
        "numViews": 2695,
        "spatialReference": "102100",
        "url": "https://services2.arcgis.com/1IylZvXQw11Lg0Zm/arcgis/rest/services/WasteCollectionBoundary_WFL1/FeatureServer",
    },
}
...
async def test_search_parses_hub_search_fields(httpx_mock):
    ...
    assert result.items[0].id == "b4195c9917694c7c9053a28025a2aff3"
    assert result.items[0].item_type == "Feature Service"
    assert result.items[0].landing_page_url.endswith("/datasets/b4195c9917694c7c9053a28025a2aff3")
...
async def test_get_dataset_maps_item_detail_and_download_links(httpx_mock):
    httpx_mock.add_response(
        url=f"{_COLLECTION_URL}/items/b4195c9917694c7c9053a28025a2aff3",
        json=_ITEM_DETAIL_FEATURE,
    )
    result = await client.get_dataset("b4195c9917694c7c9053a28025a2aff3")
    assert result.id == "b4195c9917694c7c9053a28025a2aff3"
...
async def test_query_feature_layer_returns_attributes(httpx_mock):
    ...
    service_url = "https://services2.arcgis.com/1IylZvXQw11Lg0Zm/arcgis/rest/services/WasteCollectionBoundary_WFL1/FeatureServer"
    ...
    result = await client.query_feature_layer("b4195c9917694c7c9053a28025a2aff3")
...
async def test_feature_service_embedded_error_becomes_invalid_input(httpx_mock):
    ...
    with pytest.raises(InvalidInput):
        await client.query_feature_layer("b4195c9917694c7c9053a28025a2aff3", where="garbage==")
