...
from maple_data_mcp.modules.arcgis_kitchener import client, constants
...
_SEARCH_FEATURE = {
    ...
    "properties": {
        ...
        "snippet": "Feature layer of current Boil Water Advisories issued in Kitchener.",
        "type": "Feature Service",
        "tags": ["Boil Water Advisories", "Kitchener"],
        "categories": ["/Categories/Environment"],
        "owner": "Kitchener_Government",
...
_ITEM_DETAIL_FEATURE = {
    ...
    "properties": {
        ...
        "categories": ["/Categories/Environment"],
        "owner": "Kitchener_Government",
        "licenseInfo": "<a href='https://www.kitchener.ca/council-and-city-administration/data-and-maps/open-data-licence'>Kitchener Open Data Licence</a>",
...
async def test_search_parses_hub_search_fields(httpx_mock):
    ...
    assert result.items[0].tags == ["Boil Water Advisories", "Kitchener"]
