...
from maple_data_mcp.modules.arcgis_london import client, constants
...
_SEARCH_FEATURE = {
    ...
    "properties": {
        ...
        "snippet": "Feature layer of current Boil Water Advisories issued in London.",
        "type": "Feature Service",
        "tags": ["Boil Water Advisories", "London"],
        "categories": ["/Categories/Environment"],
        "owner": "London_Government",
...
_ITEM_DETAIL_FEATURE = {
    ...
    "properties": {
        ...
        "categories": ["/Categories/Environment"],
        "owner": "London_Government",
        "licenseInfo": "<a href='https://london.ca/legal'>London Open Data Licence</a>",
...
async def test_search_parses_hub_search_fields(httpx_mock):
    ...
    assert result.items[0].tags == ["Boil Water Advisories", "London"]
