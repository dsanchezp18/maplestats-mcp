...
from maple_data_mcp.modules.arcgis_peel import client, constants
...
_SEARCH_FEATURE = {
    "id": "298ac053a25041098fcde24bd7ef95ef",
    "type": "Feature",
    "geometry": None,
    "properties": {
        "id": "298ac053a25041098fcde24bd7ef95ef",
        "title": "Municipal Boundary",
        "snippet": "The boundaries of the municipalities within the Region of Peel.",
        "type": "Feature Service",
        "tags": ["Boundaries", "Municipality", "Peel"],
        "categories": [],
        "owner": "shahir.alam@peelregion.ca_RegionofPeel",
        "modified": 1769627781000,
        "numViews": 5563176,
    },
}

_ITEM_DETAIL_FEATURE = {
    "id": "298ac053a25041098fcde24bd7ef95ef_0",
    "type": "Feature",
    "geometry": None,
    "properties": {
        "id": "298ac053a25041098fcde24bd7ef95ef",
        "title": "Municipal Boundary",
        "description": "The boundaries of the municipalities within the Region of Peel.",
        "type": "Feature Service",
        "tags": ["Boundaries", "Municipality", "Peel"],
        "categories": [],
        "owner": "shahir.alam@peelregion.ca_RegionofPeel",
        "licenseInfo": "<a href='https://data.peelregion.ca/pages/license'>Open Data Licence for Peel</a>",
        "created": 1575035145000,
        "modified": 1769627781000,
        "numViews": 5563176,
        "spatialReference": "102100",
        "url": "https://services6.arcgis.com/ONZht79c8QWuX759/arcgis/rest/services/Municipal_Boundary/FeatureServer",
    },
}
...
async def test_search_parses_hub_search_fields(httpx_mock):
    ...
    assert result.items[0].id == "298ac053a25041098fcde24bd7ef95ef"
    assert result.items[0].item_type == "Feature Service"
    assert result.items[0].landing_page_url.endswith("/datasets/298ac053a25041098fcde24bd7ef95ef")
...
async def test_get_dataset_maps_item_detail_and_download_links(httpx_mock):
    httpx_mock.add_response(
        url=f"{_COLLECTION_URL}/items/298ac053a25041098fcde24bd7ef95ef",
        json=_ITEM_DETAIL_FEATURE,
    )
    result = await client.get_dataset("298ac053a25041098fcde24bd7ef95ef")
    assert result.id == "298ac053a25041098fcde24bd7ef95ef"
...
async def test_query_feature_layer_returns_attributes(httpx_mock):
    ...
    service_url = "https://services6.arcgis.com/ONZht79c8QWuX759/arcgis/rest/services/Municipal_Boundary/FeatureServer"
    ...
    result = await client.query_feature_layer("298ac053a25041098fcde24bd7ef95ef")
...
async def test_feature_service_embedded_error_becomes_invalid_input(httpx_mock):
    ...
    with pytest.raises(InvalidInput):
        await client.query_feature_layer("298ac053a25041098fcde24bd7ef95ef", where="garbage==")
