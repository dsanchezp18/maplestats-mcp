...
from maple_data_mcp.modules.nrcan_energy_use import client
from maple_data_mcp.modules.nrcan_energy_use.schemas import EnergyTable, ProductList, TableList
