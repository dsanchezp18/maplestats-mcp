...
from maple_data_mcp.modules.arcgis_saskatoon import client, constants
...
_SEARCH_FEATURE = {
    ...
    "properties": {
        ...
        "snippet": "Feature layer of current Boil Water Advisories issued in Saskatoon.",
        "type": "Feature Service",
        "tags": ["Boil Water Advisories", "Saskatoon"],
        "categories": ["/Categories/Environment"],
        "owner": "Saskatoon_Government",
...
_ITEM_DETAIL_FEATURE = {
    ...
    "properties": {
        ...
        "categories": ["/Categories/Environment"],
        "owner": "Saskatoon_Government",
        "licenseInfo": "<a href='https://www.saskatoon.ca/legal'>Saskatoon Open Data Licence</a>",
...
async def test_search_parses_hub_search_fields(httpx_mock):
    ...
    assert result.items[0].tags == ["Boil Water Advisories", "Saskatoon"]
