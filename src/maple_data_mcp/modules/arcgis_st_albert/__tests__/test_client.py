...
from maple_data_mcp.modules.arcgis_st_albert import client, constants
...
_SEARCH_FEATURE = {
    "id": "bd4d51c8588c40408b0154fbb5531f9f",
    "type": "Feature",
    "geometry": None,
    "properties": {
        "id": "bd4d51c8588c40408b0154fbb5531f9f",
        "title": "Building Footprint",
        "snippet": "Building Footprint for the City of St. Albert, updated weekly.",
        "type": "Feature Service",
        "tags": ["BuildingFootpint", "Structure"],
        "categories": [],
        "owner": "open@stalbert.ca",
        "modified": 1779381680000,
        "numViews": 34,
    },
}

_ITEM_DETAIL_FEATURE = {
    "id": "bd4d51c8588c40408b0154fbb5531f9f_0",
    "type": "Feature",
    "geometry": None,
    "properties": {
        "id": "bd4d51c8588c40408b0154fbb5531f9f",
        "title": "Building Footprint",
        "description": "Building Footprint for the City of St. Albert, updated weekly.",
        "type": "Feature Service",
        "tags": ["BuildingFootpint", "Structure"],
        "categories": [],
        "owner": "open@stalbert.ca",
        "licenseInfo": "<a href='https://data.stalbert.ca/pages/licence'>City of St. Albert Open Data License</a>",
        "created": 1778609304000,
        "modified": 1779381680000,
        "numViews": 34,
        "spatialReference": "102100",
        "url": "https://services1.arcgis.com/fyyY0cNXvmUWvX1x/arcgis/rest/services/ST_BuildingFootprint/FeatureServer",
    },
}
...
async def test_search_parses_hub_search_fields(httpx_mock):
    ...
    assert result.items[0].id == "bd4d51c8588c40408b0154fbb5531f9f"
    assert result.items[0].item_type == "Feature Service"
    assert result.items[0].landing_page_url.endswith("/datasets/bd4d51c8588c40408b0154fbb5531f9f")
...
async def test_get_dataset_maps_item_detail_and_download_links(httpx_mock):
    httpx_mock.add_response(
        url=f"{_COLLECTION_URL}/items/bd4d51c8588c40408b0154fbb5531f9f",
        json=_ITEM_DETAIL_FEATURE,
    )
    result = await client.get_dataset("bd4d51c8588c40408b0154fbb5531f9f")
    assert result.id == "bd4d51c8588c40408b0154fbb5531f9f"
...
async def test_query_feature_layer_returns_attributes(httpx_mock):
    ...
    service_url = "https://services1.arcgis.com/fyyY0cNXvmUWvX1x/arcgis/rest/services/ST_BuildingFootprint/FeatureServer"
    ...
    result = await client.query_feature_layer("bd4d51c8588c40408b0154fbb5531f9f")
...
async def test_feature_service_embedded_error_becomes_invalid_input(httpx_mock):
    ...
    with pytest.raises(InvalidInput):
        await client.query_feature_layer("bd4d51c8588c40408b0154fbb5531f9f", where="garbage==")
