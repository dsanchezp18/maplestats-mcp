...
from maple_data_mcp.modules.arcgis_waterloo_region import client, constants
...
_SEARCH_FEATURE = {
    "id": "bf6cef787e894d1eaadac498a206ae52",
    "type": "Feature",
    "geometry": None,
    "properties": {
        "id": "bf6cef787e894d1eaadac498a206ae52",
        "title": "Storm_Pipes",
        "snippet": "Storm Pipes. Summary: Inventory of stormwater pipes.",
        "type": "Feature Service",
        "tags": ["Infrastructure", "Stormwater", "Region of Waterloo"],
        "categories": [],
        "owner": "KitchenerGIS",
        "modified": 1789464676000,
        "numViews": 53762,
    },
}

_ITEM_DETAIL_FEATURE = {
    "id": "bf6cef787e894d1eaadac498a206ae52_0",
    "type": "Feature",
    "geometry": None,
    "properties": {
        "id": "bf6cef787e894d1eaadac498a206ae52",
        "title": "Storm_Pipes",
        "description": "Storm Pipes. Summary: Inventory of stormwater pipes.",
        "type": "Feature Service",
        "tags": ["Infrastructure", "Stormwater", "Region of Waterloo"],
        "categories": [],
        "owner": "KitchenerGIS",
        "licenseInfo": "<p>Open Government Licence - The Corporation of the City of Kitchener.</p>",
        "created": 1528916662000,
        "modified": 1789464676000,
        "numViews": 53762,
        "spatialReference": "102100",
        "url": "https://services1.arcgis.com/qAo1OsXi67t7XgmS/arcgis/rest/services/Storm_Pipes/FeatureServer",
    },
}
...
async def test_search_parses_hub_search_fields(httpx_mock):
    ...
    assert result.items[0].id == "bf6cef787e894d1eaadac498a206ae52"
    assert result.items[0].item_type == "Feature Service"
    assert result.items[0].landing_page_url.endswith("/datasets/bf6cef787e894d1eaadac498a206ae52")
...
async def test_get_dataset_maps_item_detail_and_download_links(httpx_mock):
    httpx_mock.add_response(
        url=f"{_COLLECTION_URL}/items/bf6cef787e894d1eaadac498a206ae52",
        json=_ITEM_DETAIL_FEATURE,
    )
    result = await client.get_dataset("bf6cef787e894d1eaadac498a206ae52")
    assert result.id == "bf6cef787e894d1eaadac498a206ae52"
...
async def test_query_feature_layer_returns_attributes(httpx_mock):
    ...
    service_url = "https://services1.arcgis.com/qAo1OsXi67t7XgmS/arcgis/rest/services/Storm_Pipes/FeatureServer"
    ...
    result = await client.query_feature_layer("bf6cef787e894d1eaadac498a206ae52")
...
async def test_feature_service_embedded_error_becomes_invalid_input(httpx_mock):
    ...
    with pytest.raises(InvalidInput):
        await client.query_feature_layer("bf6cef787e894d1eaadac498a206ae52", where="garbage==")
