...
from maple_data_mcp.modules.arcgis_windsor import client, constants
...
_SEARCH_FEATURE = {
    ...
    "properties": {
        ...
        "snippet": "Feature layer of current Boil Water Advisories issued in Windsor.",
        "type": "Feature Service",
        "tags": ["Boil Water Advisories", "Windsor"],
        "categories": ["/Categories/Environment"],
        "owner": "Windsor_Government",
...
_ITEM_DETAIL_FEATURE = {
    ...
    "properties": {
        ...
        "categories": ["/Categories/Environment"],
        "owner": "Windsor_Government",
        "licenseInfo": "<a href='https://www.citywindsor.ca/legal'>Windsor Open Data Licence</a>",
...
async def test_search_parses_hub_search_fields(httpx_mock):
    ...
    assert result.items[0].tags == ["Boil Water Advisories", "Windsor"]
