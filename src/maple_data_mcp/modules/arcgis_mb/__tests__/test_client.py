...
from maple_data_mcp.modules.arcgis_mb import client, constants
...
_SEARCH_FEATURE = {
    ...
    "properties": {
        ...
        "snippet": "Feature layer of current Boil Water Advisories issued in Manitoba.",
        "type": "Feature Service",
        "tags": ["Boil Water Advisories", "Manitoba"],
...
async def test_search_parses_hub_search_fields(httpx_mock):
    ...
    assert result.items[0].tags == ["Boil Water Advisories", "Manitoba"]
