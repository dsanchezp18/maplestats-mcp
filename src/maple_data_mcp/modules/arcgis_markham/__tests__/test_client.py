...
from maple_data_mcp.modules.arcgis_markham import client, constants
...
_SEARCH_FEATURE = {
    "id": "7791a0d2e3d3422b8eab3c800be5c4e7",
    "type": "Feature",
    "geometry": None,
    "properties": {
        "id": "7791a0d2e3d3422b8eab3c800be5c4e7",
        "title": "Civic Addresses",
        "snippet": "Spatial (point) layer of municipal addresses in the City of Markham.",
        "type": "Feature Service",
        "tags": ["City of Markham", "Address", "Markham"],
        "categories": [],
        "owner": "City_of_Markham",
        "modified": 1750120379000,
        "numViews": 19089,
    },
}

_ITEM_DETAIL_FEATURE = {
    "id": "7791a0d2e3d3422b8eab3c800be5c4e7_0",
    "type": "Feature",
    "geometry": None,
    "properties": {
        "id": "7791a0d2e3d3422b8eab3c800be5c4e7",
        "title": "Civic Addresses",
        "description": "Spatial (point) layer of municipal addresses in the City of Markham.",
        "type": "Feature Service",
        "tags": ["City of Markham", "Address", "Markham"],
        "categories": [],
        "owner": "City_of_Markham",
        "licenseInfo": "<a href='http://data-markham.opendata.arcgis.com/pages/terms-of-use'>Markham Terms of Use</a>",
        "created": 1532720351000,
        "modified": 1750120379000,
        "numViews": 19089,
        "spatialReference": "102100",
        "url": "https://utility.arcgis.com/usrsvcs/servers/7791a0d2e3d3422b8eab3c800be5c4e7/rest/services/OpenData/OD_ADDRESSES/FeatureServer",
    },
}
...
async def test_search_parses_hub_search_fields(httpx_mock):
    ...
    assert result.items[0].id == "7791a0d2e3d3422b8eab3c800be5c4e7"
    assert result.items[0].item_type == "Feature Service"
    assert result.items[0].landing_page_url.endswith("/datasets/7791a0d2e3d3422b8eab3c800be5c4e7")
...
async def test_get_dataset_maps_item_detail_and_download_links(httpx_mock):
    httpx_mock.add_response(
        url=f"{_COLLECTION_URL}/items/7791a0d2e3d3422b8eab3c800be5c4e7",
        json=_ITEM_DETAIL_FEATURE,
    )
    result = await client.get_dataset("7791a0d2e3d3422b8eab3c800be5c4e7")
    assert result.id == "7791a0d2e3d3422b8eab3c800be5c4e7"
...
async def test_query_feature_layer_returns_attributes(httpx_mock):
    ...
    service_url = "https://utility.arcgis.com/usrsvcs/servers/7791a0d2e3d3422b8eab3c800be5c4e7/rest/services/OpenData/OD_ADDRESSES/FeatureServer"
    ...
    result = await client.query_feature_layer("7791a0d2e3d3422b8eab3c800be5c4e7")
...
async def test_feature_service_embedded_error_becomes_invalid_input(httpx_mock):
    ...
    with pytest.raises(InvalidInput):
        await client.query_feature_layer("7791a0d2e3d3422b8eab3c800be5c4e7", where="garbage==")
