...
from maple_data_mcp.modules.arcgis_airdrie import client, constants
...
_SEARCH_FEATURE = {
    "id": "5dd3c1196f4248e5ac218674c7513a5d",
    "type": "Feature",
    "geometry": None,
    "properties": {
        "id": "5dd3c1196f4248e5ac218674c7513a5d",
        "title": "Airdrie Land Use Districts",
        "snippet": "Land use districts by land parcel. Updated weekly.",
        "type": "Feature Service",
        "tags": ["Airdrie", "Alberta", "Land Use Districts"],
        "categories": [],
        "owner": "Airdrie_GIS",
        "modified": 1722360708000,
        "numViews": 62278,
    },
}

_ITEM_DETAIL_FEATURE = {
    "id": "5dd3c1196f4248e5ac218674c7513a5d_0",
    "type": "Feature",
    "geometry": None,
    "properties": {
        "id": "5dd3c1196f4248e5ac218674c7513a5d",
        "title": "Airdrie Land Use Districts",
        "description": "Land use districts by land parcel. Updated weekly.",
        "type": "Feature Service",
        "tags": ["Airdrie", "Alberta", "Land Use Districts"],
        "categories": [],
        "owner": "Airdrie_GIS",
        "licenseInfo": "<p>City of Airdrie Open Data Licence.</p>",
        "created": 1501019434000,
        "modified": 1722360708000,
        "numViews": 62278,
        "spatialReference": "102100",
        "url": "https://services1.arcgis.com/bctnJobT0aahg98G/arcgis/rest/services/Airdrie_Land_Use_Districts/FeatureServer",
    },
}
...
async def test_search_parses_hub_search_fields(httpx_mock):
    ...
    assert result.items[0].id == "5dd3c1196f4248e5ac218674c7513a5d"
    assert result.items[0].item_type == "Feature Service"
    assert result.items[0].landing_page_url.endswith("/datasets/5dd3c1196f4248e5ac218674c7513a5d")
...
async def test_get_dataset_maps_item_detail_and_download_links(httpx_mock):
    httpx_mock.add_response(
        url=f"{_COLLECTION_URL}/items/5dd3c1196f4248e5ac218674c7513a5d",
        json=_ITEM_DETAIL_FEATURE,
    )
    result = await client.get_dataset("5dd3c1196f4248e5ac218674c7513a5d")
    assert result.id == "5dd3c1196f4248e5ac218674c7513a5d"
...
async def test_query_feature_layer_returns_attributes(httpx_mock):
    ...
    service_url = "https://services1.arcgis.com/bctnJobT0aahg98G/arcgis/rest/services/Airdrie_Land_Use_Districts/FeatureServer"
    ...
    result = await client.query_feature_layer("5dd3c1196f4248e5ac218674c7513a5d")
...
async def test_feature_service_embedded_error_becomes_invalid_input(httpx_mock):
    ...
    with pytest.raises(InvalidInput):
        await client.query_feature_layer("5dd3c1196f4248e5ac218674c7513a5d", where="garbage==")
