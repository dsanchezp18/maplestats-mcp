"""Constants for the Metro Vancouver's ArcGIS Hub deployment."""

DOMAIN = "open-data-portal-metrovancouver.hub.arcgis.com"
RATE_LIMIT_SOURCE = "arcgis-metro-vancouver"
