"""City of Calgary Open Data (data.calgary.ca), Socrata (SODA) platform.

Confirmed live 2026-09-19 against the cross-domain discovery API
(api.us.socrata.com, 413 datasets), the per-domain Views API, and the
...
MODULE_NAME = "socrata_calgary"
MODULE_DESCRIPTION = (
    "City of Calgary Open Data (data.calgary.ca): Calgary's Socrata open-data "
    "catalogue, with dataset search and detail, categories, tags, and direct "
    "SoQL row queries. English-only."
)
MODULE_DESCRIPTION_FR = (
    "Données ouvertes de la Ville de Calgary (data.calgary.ca) : catalogue "
    "de données ouvertes de Calgary fondé sur Socrata, avec recherche et "
