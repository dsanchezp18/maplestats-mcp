...
from maple_data_mcp.modules.arcgis_halifax import client, constants
...
_SEARCH_FEATURE = {
    "id": "057ac4a8514e4e12b6085d9d87d98f01",
    "type": "Feature",
    "geometry": None,
    "properties": {
        "id": "057ac4a8514e4e12b6085d9d87d98f01",
        "title": "Parks and Recreation Arena Bookings",
        "snippet": "This dataset lists arena bookings from HRM's Xplor booking system.",
        "type": "Feature Service",
        "tags": ["Arena", "Bookings", "Halifax", "HRM"],
        "categories": [],
        "owner": "opendata_HRM",
        "modified": 1789812431000,
        "numViews": 1412,
    },
}

_ITEM_DETAIL_FEATURE = {
    "id": "057ac4a8514e4e12b6085d9d87d98f01_0",
    "type": "Feature",
    "geometry": None,
    "properties": {
        "id": "057ac4a8514e4e12b6085d9d87d98f01",
        "title": "Parks and Recreation Arena Bookings",
        "description": "This dataset lists arena bookings from HRM's Xplor booking system.",
        "type": "Feature Service",
        "tags": ["Arena", "Bookings", "Halifax", "HRM"],
        "categories": [],
        "owner": "opendata_HRM",
        "licenseInfo": "<a href='https://data-hrm.hub.arcgis.com/pages/open-data-licence'>Open Data Licence</a>",
        "created": 1770756505000,
        "modified": 1789812431000,
        "numViews": 1412,
        "spatialReference": "102100",
        "url": "https://services2.arcgis.com/11XBiaBYA9Ep0yNJ/arcgis/rest/services/Parks_and_Recreation_Arena_Bookings/FeatureServer",
    },
}
...
async def test_search_parses_hub_search_fields(httpx_mock):
    ...
    assert result.items[0].id == "057ac4a8514e4e12b6085d9d87d98f01"
    assert result.items[0].item_type == "Feature Service"
    assert result.items[0].landing_page_url.endswith("/datasets/057ac4a8514e4e12b6085d9d87d98f01")
...
async def test_get_dataset_maps_item_detail_and_download_links(httpx_mock):
    httpx_mock.add_response(
        url=f"{_COLLECTION_URL}/items/057ac4a8514e4e12b6085d9d87d98f01",
        json=_ITEM_DETAIL_FEATURE,
    )
    result = await client.get_dataset("057ac4a8514e4e12b6085d9d87d98f01")
    assert result.id == "057ac4a8514e4e12b6085d9d87d98f01"
...
async def test_query_feature_layer_returns_attributes(httpx_mock):
    ...
    service_url = "https://services2.arcgis.com/11XBiaBYA9Ep0yNJ/arcgis/rest/services/Parks_and_Recreation_Arena_Bookings/FeatureServer"
    ...
    result = await client.query_feature_layer("057ac4a8514e4e12b6085d9d87d98f01")
...
async def test_feature_service_embedded_error_becomes_invalid_input(httpx_mock):
    ...
    with pytest.raises(InvalidInput):
        await client.query_feature_layer("057ac4a8514e4e12b6085d9d87d98f01", where="garbage==")
