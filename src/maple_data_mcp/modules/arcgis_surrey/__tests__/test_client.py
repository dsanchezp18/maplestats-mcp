...
from maple_data_mcp.modules.arcgis_surrey import client, constants
...
_SEARCH_FEATURE = {
    ...
    "properties": {
        ...
        "snippet": "Feature layer of current Boil Water Advisories issued in Surrey.",
        "type": "Feature Service",
        "tags": ["Boil Water Advisories", "Surrey"],
        "categories": ["/Categories/Environment"],
        "owner": "Surrey_Government",
...
_ITEM_DETAIL_FEATURE = {
    ...
    "properties": {
        ...
        "categories": ["/Categories/Environment"],
        "owner": "Surrey_Government",
        "licenseInfo": "<a href='https://www.surrey.ca/legal'>Surrey Open Data Licence</a>",
...
async def test_search_parses_hub_search_fields(httpx_mock):
    ...
    assert result.items[0].tags == ["Boil Water Advisories", "Surrey"]
