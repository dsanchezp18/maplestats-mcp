...
from maple_data_mcp.modules.cmhc.data_tables import client
from maple_data_mcp.modules.cmhc.data_tables.schemas import DownloadLink, TableDetail, TableList
