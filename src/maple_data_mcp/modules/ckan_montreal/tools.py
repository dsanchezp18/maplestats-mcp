...
from maple_data_mcp.modules.ckan_montreal.constants import (
...
@tool
async def ckan_montreal_datastore_search(
    resource_id: str,
    ...
    """Query actual row data from one DataStore-active Montreal resource, not just its metadata.
    ...
    resource (from ckan_montreal_get_dataset or ckan_montreal_get_resource) before
    ...
    filtre, Montreal, données ouvertes.
    """
