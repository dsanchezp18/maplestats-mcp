"""City of Edmonton Open Data (data.edmonton.ca), Socrata (SODA) platform.

Confirmed live 2026-09-19 against the cross-domain discovery API
(api.us.socrata.com, 1,421 datasets), the per-domain Views API, and the
...
MODULE_NAME = "socrata_edmonton"
MODULE_DESCRIPTION = (
    "City of Edmonton Open Data (data.edmonton.ca): Edmonton's Socrata open-data "
    "catalogue, with dataset search and detail, categories, tags, and direct "
    "SoQL row queries. English-only."
)
MODULE_DESCRIPTION_FR = (
    "Données ouvertes de la Ville d'Edmonton (data.edmonton.ca) : catalogue "
    "de données ouvertes d'Edmonton fondé sur Socrata, avec recherche et "
