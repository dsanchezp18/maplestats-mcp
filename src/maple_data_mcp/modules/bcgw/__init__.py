...
existing `ckan_bc_*` catalogue tools: a WFS/WMS-queryable BC dataset's
...
MODULE_DESCRIPTION = (
    ...
    "thousands of layers by type_name (discoverable via ckan_bc_*)."
)
MODULE_DESCRIPTION_FR = (
    ...
    "milliers de couches du BCGW par type_name (découvrable via ckan_bc_*)."
)
