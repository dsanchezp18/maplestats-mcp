...
from maple_data_mcp.modules.statcan.census_tables import constants
from maple_data_mcp.modules.statcan.census_tables.schemas import (
    CensusTable,
...
from maple_data_mcp.shared.http import get_raw, new_client
