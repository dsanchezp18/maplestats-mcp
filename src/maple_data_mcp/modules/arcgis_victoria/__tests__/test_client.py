...
from maple_data_mcp.modules.arcgis_victoria import client, constants
...
_SEARCH_FEATURE = {
    ...
    "properties": {
        ...
        "snippet": "Feature layer of current Boil Water Advisories issued in Victoria.",
        "type": "Feature Service",
        "tags": ["Boil Water Advisories", "Victoria"],
        "categories": ["/Categories/Environment"],
        "owner": "Victoria_Government",
...
_ITEM_DETAIL_FEATURE = {
    ...
    "properties": {
        ...
        "categories": ["/Categories/Environment"],
        "owner": "Victoria_Government",
        "licenseInfo": "<a href='https://www.victoria.ca/legal'>Victoria Open Data Licence</a>",
...
async def test_search_parses_hub_search_fields(httpx_mock):
    ...
    assert result.items[0].tags == ["Boil Water Advisories", "Victoria"]
