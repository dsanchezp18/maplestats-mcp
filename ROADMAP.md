...
| IRCC monthly updates (permanent and temporary residents, asylum) | Candidate module | Checked 2026-09-25: 8 current monthly datasets; the `ODP-*.csv` files are tab-separated long tables, January 2015 to the latest month, by province, CMA, census subdivision, citizenship, category, occupation, age and gender; rounded to 5, `--` suppressed. [Details](docs/findings/specialized-federal-sources.md#ircc-monthly-updates-permanent-and-temporary-residents-asylum) |
...
| Parliamentary Budget Officer | Investigated, not usable | Checked 2026-09-25: reports only, no data endpoint. [Details](docs/findings/specialized-federal-sources.md#parliamentary-budget-officer) |
