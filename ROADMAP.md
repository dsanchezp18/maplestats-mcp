...
| Parliamentary Budget Officer | Candidate module | Checked 2026-09-26: publication pages embed PBOML (YAML) with bilingual tables for cost estimates and notes; interactive tools load static JSON (e.g. the federal employment tracker). [Details](docs/findings/specialized-federal-sources.md#parliamentary-budget-officer) |
| Institut de la statistique du Québec (ISQ) | Candidate module | Checked 2026-09-26: 3,538 English detailed tables in the sitemap; static tables embed HTML plus an Excel copy, dynamic ones come from BDSO (disallowed by robots.txt) with a full XLSX for some. Terms of use to check. [Details](docs/findings/provincial-sources.md#institut-de-la-statistique-du-québec-isq) |
