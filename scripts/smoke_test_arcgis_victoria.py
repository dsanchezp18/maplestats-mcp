"""Live smoke test for the City of Victoria's ArcGIS Hub client."""
...
async def main() -> int:
    ...
    print(f"Victoria total matches for {search.query!r}: {search.total_count}")
    print("ARCGIS-VICTORIA SMOKE TEST PASSED")
    return 0
