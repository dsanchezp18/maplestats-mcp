"""Live smoke test for the Strathcona County ArcGIS Hub client."""
...
async def main() -> int:
    ...
    print(f"Strathcona County total matches for {search.query!r}: {search.total_count}")
    print("ARCGIS-STRATHCONA_COUNTY SMOKE TEST PASSED")
    return 0
