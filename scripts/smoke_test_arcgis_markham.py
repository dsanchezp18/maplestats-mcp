"""Live smoke test for the Markham ArcGIS Hub client."""
...
async def main() -> int:
    ...
    print(f"Markham total matches for {search.query!r}: {search.total_count}")
    print("ARCGIS-MARKHAM SMOKE TEST PASSED")
    return 0
