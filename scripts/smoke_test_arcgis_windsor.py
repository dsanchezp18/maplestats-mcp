"""Live smoke test for the City of Windsor's ArcGIS Hub client."""
...
async def main() -> int:
    ...
    print(f"Windsor total matches for {search.query!r}: {search.total_count}")
    print("ARCGIS-WINDSOR SMOKE TEST PASSED")
    return 0
