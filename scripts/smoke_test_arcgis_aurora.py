"""Live smoke test for the Aurora ArcGIS Hub client."""
...
async def main() -> int:
    ...
    print(f"Aurora total matches for {search.query!r}: {search.total_count}")
    print("ARCGIS-AURORA SMOKE TEST PASSED")
    return 0
