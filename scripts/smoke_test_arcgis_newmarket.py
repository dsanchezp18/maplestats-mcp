"""Live smoke test for the Newmarket ArcGIS Hub client."""
...
async def main() -> int:
    ...
    print(f"Newmarket total matches for {search.query!r}: {search.total_count}")
    print("ARCGIS-NEWMARKET SMOKE TEST PASSED")
    return 0
