"""Live smoke test for the St. Albert ArcGIS Hub client."""
...
async def main() -> int:
    ...
    print(f"St. Albert total matches for {search.query!r}: {search.total_count}")
    print("ARCGIS-ST_ALBERT SMOKE TEST PASSED")
    return 0
