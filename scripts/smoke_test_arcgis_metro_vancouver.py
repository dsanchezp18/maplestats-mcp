"""Live smoke test for the Metro Vancouver ArcGIS Hub client."""
...
async def main() -> int:
    ...
    print(f"Metro Vancouver total matches for {search.query!r}: {search.total_count}")
    print("ARCGIS-METRO_VANCOUVER SMOKE TEST PASSED")
    return 0
