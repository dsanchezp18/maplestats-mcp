"""Live smoke test for the Grande Prairie ArcGIS Hub client."""
...
async def main() -> int:
    ...
    print(f"Grande Prairie total matches for {search.query!r}: {search.total_count}")
    print("ARCGIS-GRANDE_PRAIRIE SMOKE TEST PASSED")
    return 0
