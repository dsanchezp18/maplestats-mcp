"""Live smoke test for the Ottawa ArcGIS Hub client."""
...
async def main() -> int:
    ...
    print(f"Ottawa total matches for {search.query!r}: {search.total_count}")
    print("ARCGIS-OTTAWA SMOKE TEST PASSED")
    return 0
