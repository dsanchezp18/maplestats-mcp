"""Live smoke test for the Region of Waterloo ArcGIS Hub client."""
...
async def main() -> int:
    ...
    print(f"Region of Waterloo total matches for {search.query!r}: {search.total_count}")
    print("ARCGIS-WATERLOO_REGION SMOKE TEST PASSED")
    return 0
