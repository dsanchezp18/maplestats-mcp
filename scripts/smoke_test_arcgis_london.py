"""Live smoke test for the City of London's ArcGIS Hub client."""
...
async def main() -> int:
    ...
    print(f"London total matches for {search.query!r}: {search.total_count}")
    print("ARCGIS-LONDON SMOKE TEST PASSED")
    return 0
