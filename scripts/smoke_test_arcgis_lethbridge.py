"""Live smoke test for the Lethbridge ArcGIS Hub client."""
...
async def main() -> int:
    ...
    print(f"Lethbridge total matches for {search.query!r}: {search.total_count}")
    print("ARCGIS-LETHBRIDGE SMOKE TEST PASSED")
    return 0
