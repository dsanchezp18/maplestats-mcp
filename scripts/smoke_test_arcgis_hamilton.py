"""Live smoke test for the City of Hamilton's ArcGIS Hub client."""
...
async def main() -> int:
    ...
    print(f"Hamilton total matches for {search.query!r}: {search.total_count}")
    print("ARCGIS-HAMILTON SMOKE TEST PASSED")
    return 0
