"""Live smoke test for the York ArcGIS Hub client."""
...
async def main() -> int:
    ...
    print(f"York total matches for {search.query!r}: {search.total_count}")
    print("ARCGIS-YORK SMOKE TEST PASSED")
    return 0
