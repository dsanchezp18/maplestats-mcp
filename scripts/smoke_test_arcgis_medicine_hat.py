"""Live smoke test for the Medicine Hat ArcGIS Hub client."""
...
async def main() -> int:
    ...
    print(f"Medicine Hat total matches for {search.query!r}: {search.total_count}")
    print("ARCGIS-MEDICINE_HAT SMOKE TEST PASSED")
    return 0
