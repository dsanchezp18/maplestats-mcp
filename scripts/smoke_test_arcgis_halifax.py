"""Live smoke test for the Halifax ArcGIS Hub client."""
...
async def main() -> int:
    ...
    print(f"Halifax total matches for {search.query!r}: {search.total_count}")
    print("ARCGIS-HALIFAX SMOKE TEST PASSED")
    return 0
