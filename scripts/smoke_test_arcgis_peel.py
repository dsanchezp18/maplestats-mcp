"""Live smoke test for the Peel ArcGIS Hub client."""
...
async def main() -> int:
    ...
    print(f"Peel total matches for {search.query!r}: {search.total_count}")
    print("ARCGIS-PEEL SMOKE TEST PASSED")
    return 0
