"""Live smoke test for the City of Kitchener's ArcGIS Hub client."""
...
async def main() -> int:
    ...
    print(f"Kitchener total matches for {search.query!r}: {search.total_count}")
    print("ARCGIS-KITCHENER SMOKE TEST PASSED")
    return 0
