"""Live smoke test for the Mississauga ArcGIS Hub client."""
...
async def main() -> int:
    ...
    print(f"Mississauga total matches for {search.query!r}: {search.total_count}")
    print("ARCGIS-MISSISSAUGA SMOKE TEST PASSED")
    return 0
