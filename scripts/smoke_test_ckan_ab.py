"""Live smoke test for the Open Alberta CKAN client."""
...
async def main() -> int:
    ...
    if not search.packages:
        print("FAIL: Alberta returned no housing search results")
        return 1
    ...
    if not detail.resources or detail.organization is None:
        print("FAIL: Alberta sample has no organization or resource to continue smoke checks")
        return 1
    ...
    print("CKAN-AB SMOKE TEST PASSED")
    return 0
