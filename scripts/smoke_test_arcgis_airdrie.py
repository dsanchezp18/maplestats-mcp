"""Live smoke test for the Airdrie ArcGIS Hub client."""
...
async def main() -> int:
    ...
    print(f"Airdrie total matches for {search.query!r}: {search.total_count}")
    print("ARCGIS-AIRDRIE SMOKE TEST PASSED")
    return 0
