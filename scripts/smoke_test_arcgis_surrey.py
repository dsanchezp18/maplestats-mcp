"""Live smoke test for the City of Surrey's ArcGIS Hub client."""
...
async def main() -> int:
    ...
    print(f"Surrey total matches for {search.query!r}: {search.total_count}")
    print("ARCGIS-SURREY SMOKE TEST PASSED")
    return 0
